...
// TODO oldDisplayAnswers and answers objects need to be merged in a clearer object
// Create the oldDisplayAnswers object
// First loop to create an element in oldDisplayAnswers for each candidate
//   for (let i=0; i<2; i++) {
...
//     this.oldDisplayAnswers[this.candidacies[i].id] = {yes: [], no: [], photo: photo, name: name};
//   }
//   // Add propositions to oldDisplayAnswers Object
//   this.answers.forEach(answer => {
//     answer.approved?
//       this.oldDisplayAnswers[answer.proposition.candidacy.id].yes.push(answer.proposition):
//       this.oldDisplayAnswers[answer.proposition.candidacy.id].no.push(answer.proposition);
//   });
